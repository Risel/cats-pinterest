...
import styles from './SingleCat.module.scss'
import { setFavourite } from "../../../store/slices/catsSlice";
...
const SingleCat = ({cat}) => {
  ...
  function toggleLike() {
    dispatch(setFavourite(cat.id))
  }

  return <div className={styles.root} 
    onMouseOver={()=>setIsHovered(true)}  
    onMouseLeave={()=>setIsHovered(false)}>
    <img className={styles.cat} src={cat.url} alt="cat"/>
    {isHovered &&
        (cat.isFavourite ? 
        (
          <svg className = {styles.icon} onClick={toggleLike} width="40" height="37" viewBox="0 0 40 37" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className={styles.icon} onClick={toggleLike} width="40" height="37" viewBox="0 0 40 37" xmlns="http://www.w3.org/2000/svg">
